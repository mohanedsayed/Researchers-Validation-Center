...
| **Task Queue & Orchestration** | **Temporal.io** | لإدارة الجلسات المعقدة بشكل موثوق، وتنفيذ المهام الخلفية الموزعة (مثل الـ Chunker)، وربط الخدمات المنفصلة. |
| **Payment Gateway** | **Lemon Squeezy API** | معالجة آمنة للمدفوعات، دعم ممتاز لنظام الاشتراكات والرصيد (Credits)، وتوثيق برمجي سهل. |
...
*   **FR-SESS-03: إدارة دورة الحياة:**
    *   استخدام مهام مجدولة عبر **Temporal Cron Jobs** لفحص الجلسات المنتهية (>24 ساعة).
...
*   **FR-PAY-01: بوابة Lemon Squeezy:**
    *   إنشاء `Checkout Session` لشراء الرصيد أو تفعيل الاشتراكات.
...
4.  **Phase 4: Reporting & UI:** بناء واجهة React وتوليد التقارير النهائية (شاملاً SSE عبر Redis).
5.  **Phase 5: Payments & Security:** دمج Lemon Squeezy وتفعيل سياسة الحذف التلقائي.
